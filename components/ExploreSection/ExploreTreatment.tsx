...
const ExploreTreatment = (props: Props) => {
  return (
    <div className='py-[90px] md:py-[20px] px-[50px]  sm:px-[20px] flex flex-wrap justify-center items-center 3xl:px-[240px]'>
      <img src='/explore_tm_one.svg' alt='explore_treatment card' className='md:hidden smd:w-[290px] mdl:w-[500px] mdg:flex mdg:w-[265px] lg:w-[280px] xl:w-[33%]' />
      ...
      <img src='/explore_tm_two.svg' alt='explore_treatment card' className='md:w-[300px] mdg:w-[267px] lg:w-[285px] xl:w-[33.5%] mdl:w-[500px] smd:w-[290px]' />
    </div>
  )
}
