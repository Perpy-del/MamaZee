...
const disableDatasetBackupCommand = {
  ...
  action: async (args, context) => {
    ...
    try {
      ...
      const msg = error.statusCode ? error.response.body.message : error.message || error.statusMessage;
      output.print("".concat(chalk.red("Disabling dataset backup failed: ".concat(msg)), "\n"));
    }
  }
};
...
async function downloadAsset(url, fileName, fileType, outDir) {
  ...
  await withRetry(async () => {
    ...
    response.body.pipe(node_fs.createWriteStream(assetFilePath));
  });
}
...
const downloadBackupCommand = {
  ...
  action: async (args, context) => {
    ...
    const tmpOutDir = await promises.mkdtemp(path__default.default.join(node_os.tmpdir(), "sanity-backup-"));
...
const enableDatasetBackupCommand = {
  ...
  action: async (args, context) => {
    ...
    try {
      ...
      const msg = error.statusCode ? error.response.body.message : error.message || error.statusMessage;
      output.print("".concat(chalk.red("Enabling dataset backup failed: ".concat(msg)), "\n"));
    }
  }
};
...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-b8Akb5t_.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-CIJ0eJIw.js');
    });
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-UFRbRaHZ.js');
  });
  return mod.default;
}
...
const validateDocumentsCommand$1 = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./validateAction-0AYfD3_-.js');
    });
    return mod.default(args, context);
  }
};
...
const execCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./execScript-1Ece0vQF.js');
    });
    return mod.default(args, context);
  }
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deleteApiAction-HDIu5VN4.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$a
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-ASvA6btI.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$9
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-xhyEipAe.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$8
...
const createMigrationCommand = {
  ...
  action: async (args, context) => {
    ...
    await promises.writeFile(path__default.default.join(workDir, definitionFile), renderedTemplate);
    output.print();
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-7cggO_Pd.js');
  });
  return mod.default;
}
var schemaGroup = {
...
const validateDocumentsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./validateAction-2nhZLkUm.js');
    });
    return mod.default(args, context);
  }
};
...
//# sourceMappingURL=_internal-QmuuO9Re.js.map
