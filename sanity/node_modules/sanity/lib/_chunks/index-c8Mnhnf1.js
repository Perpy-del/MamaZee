...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './structure-pNyMk_sD.js';
...
const paneMap = {
  component: lazy(() => import('./index-mZQe2RMW.js')),
  document: lazy(() => import('./pane-BJeAKwar.js')),
  documentList: lazy(() => import('./pane-43tjD0ya.js')),
  list: lazy(() => import('./index-0LpTAOhF.js'))
};
...
//# sourceMappingURL=index-c8Mnhnf1.js.map
