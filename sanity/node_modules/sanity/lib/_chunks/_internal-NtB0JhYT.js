...
async function getBuildAction() {
  const mod = await import('./buildAction-ORkiwsEk.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-z6OgGo45.js');
...
async function getDevAction() {
  const mod = await import('./devAction-OYVsAijj.js');
  return mod.default;
}
...
const validateDocumentsCommand$1 = {
  ...
  helpText: helpText$c,
  action: async (args, context) => {
    const mod = await import('./validateAction-iwvQUvyB.js');
    return mod.default(args, context);
  }
};
...
const execCommand = {
  ...
  helpText: helpText$b,
  action: async (args, context) => {
    const mod = await import('./execScript-B5_8AFY7.js');
    return mod.default(args, context);
  }
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deleteApiAction-ae4UpgKe.js');
    return mod.default(args, context);
  },
  helpText: helpText$a
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-KT6JbsMJ.js');
    return mod.default(args, context);
  },
  helpText: helpText$9
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-U2lP1Nqw.js');
    return mod.default(args, context);
  },
  helpText: helpText$8
};
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-HZauQcrN.js');
  return mod.default;
}
var schemaGroup = {
  name: "schema",
...
const validateDocumentsCommand = {
  ...
  helpText: helpText$3,
  action: async (args, context) => {
    const mod = await import('./validateAction-PXVJP_KU.js');
    return mod.default(args, context);
  }
};
...
//# sourceMappingURL=_internal-NtB0JhYT.js.map
