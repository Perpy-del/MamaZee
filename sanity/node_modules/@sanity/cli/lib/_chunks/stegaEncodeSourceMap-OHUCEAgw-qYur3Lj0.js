...
var loadEnv = require('./loadEnv-g4ij_q-T.js');
...
function stegaEncodeSourceMap(result, resultSourceMap, config) {
  ...
  if (!enabled) {
    ...
    (_a = logger == null ? void 0 : logger.error) == null ? void 0 : _a.call(logger, "[@sanity/client]: ".concat(msg), {
      result,
      resultSourceMap,
      config
    });
  ...
  if (!config.studioUrl) {
    ...
    (_c = logger == null ? void 0 : logger.error) == null ? void 0 : _c.call(logger, "[@sanity/client]: ".concat(msg), {
      result,
      resultSourceMap,
      config
    });
  ...
  if (logger) {
    ...
    if (isSkipping || isEncoding) {
      ...
      (_e = logger.log) == null ? void 0 : _e.call(logger, "[@sanity/client]: Paths encoded: ".concat(report.encoded.length, ", skipped: ").concat(report.skipped.length));
    }
...
//# sourceMappingURL=stegaEncodeSourceMap-OHUCEAgw-qYur3Lj0.js.map
